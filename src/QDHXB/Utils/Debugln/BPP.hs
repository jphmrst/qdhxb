...
makeDebuglnBPPDefs switch =   do
  ...
  then
    ...
    [d|
      ...
      dbgBLabelFn1 :: ($md m n, Blockable r) =>
                        Subject -> Int -> String -> a -> (a -> r) -> m ()
      ...
      dbgBLabelFn2 :: ($md m n, Blockable r) =>
