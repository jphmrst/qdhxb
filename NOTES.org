...
** XSD sources/samples
   - [[https://www.w3schools.com/xml/schema_elements_ref.asp][W3 Schools XSD reference]]
...
* TODO Bootstrap the whole xsd.xsd
  ...
  :VISIBILITY: content
  :END:
  - Need xsd:choice occurring for separateAndDispatchComplexContents
  - So, add another spot in the tuple for separating
* TODO OFX test 1
  :PROPERTIES:
  :VISIBILITY: content
  :END:
